...
################################################################################
##2020-12-17
TARGET_FILE = 'indefinite_loop.py'
...
def run_tests():
    ...
    if (score == tests):
        print()
        color_print('Competent Attained', "STRING")
        print()
    else:
        print()
        color_print('Competent Not Attained', "COMMENT")
        print()

    run_console_test('-39\n-3\n-18\nQ\n', 'valid numbers: 3')
    run_console_test('999999999\n-999999999\nQ\n', 'valid numbers: 2')

    if (score == tests):
        print()
        color_print('Proficient Attained', "STRING")
        print()
    else:
        print()
        color_print('Proficient Not Attained', "COMMENT")
        print()

    run_console_test('text\n10\nt\n20\ntext\nQ\n', 'valid numbers: 2')
    run_console_test('10\nt\nlol\ntext\n20\nQ\n', 'valid numbers: 2')

    if (score == tests):
        print()
        color_print('Mastery Attained', "STRING")
        print()
    else:
        print()
        color_print('Mastery Not Attained', "COMMENT")
        print()
