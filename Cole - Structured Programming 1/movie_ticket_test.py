...
################################################################################
##2020-04-30
TARGET_FILE = 'movie_ticket.py'

def run_tests():

    ##test1
    expected_output  = '------------------------------' + NEWLINE
    expected_output += '|    *** Jungle Book ***     |' + NEWLINE
    expected_output += '| Adults:                  4 |' + NEWLINE
    expected_output += '| Children:                3 |' + NEWLINE
    expected_output += '| Seniors:                 2 |' + NEWLINE
    expected_output += '| Total:            $  93.50 |' + NEWLINE    
    expected_output += '------------------------------'+ NEWLINE
    run_console_test('Jungle Book\n4\n3\n2\n',expected_output)

    ##test2
    expected_output  = '------------------------------' + NEWLINE
    expected_output += '|     *** Star Wars ***      |' + NEWLINE
    expected_output += '| Adults:                  1 |' + NEWLINE
    expected_output += '| Children:               34 |' + NEWLINE
    expected_output += '| Seniors:                 0 |' + NEWLINE
    expected_output += '| Total:            $ 293.00 |' + NEWLINE    
    expected_output += '------------------------------'+ NEWLINE
    run_console_test('Star Wars\n1\n34\n0\n',expected_output)

    ##test2
    expected_output  = '------------------------------' + NEWLINE
    expected_output += '|   *** Oh Lonesome Me ***   |' + NEWLINE
    expected_output += '| Adults:                  0 |' + NEWLINE
    expected_output += '| Children:                1 |' + NEWLINE
    expected_output += '| Seniors:                 0 |' + NEWLINE
    expected_output += '| Total:            $   8.25 |' + NEWLINE    
    expected_output += '------------------------------'+ NEWLINE
    run_console_test('Oh Lonesome Me\n0\n1\n0\n',expected_output)
