...
################################################################################
##2021-04-20
TARGET_FILE = 'multiplication_table.py'
def run_tests():

    ##test1
    expected_output  = '      10   11   12   13   14   15' + NEWLINE
    expected_output += '---------------------------------' + NEWLINE
    expected_output += ' 1:   10   11   12   13   14   15' + NEWLINE
    expected_output += ' 2:   20   22   24   26   28   30' + NEWLINE
    expected_output += ' 3:   30   33   36   39   42   45' + NEWLINE
    expected_output += ' 4:   40   44   48   52   56   60' + NEWLINE
    expected_output += ' 5:   50   55   60   65   70   75' + NEWLINE
    run_console_test('1\n5\n10\n15\n',expected_output)

    ##test2
    expected_output  = '      16   17   18   19   20' + NEWLINE
    expected_output += '----------------------------' + NEWLINE
    expected_output += ' 6:   96  102  108  114  120' + NEWLINE
    expected_output += ' 7:  112  119  126  133  140' + NEWLINE
    expected_output += ' 8:  128  136  144  152  160' + NEWLINE
    expected_output += ' 9:  144  153  162  171  180' + NEWLINE
    expected_output += '10:  160  170  180  190  200' + NEWLINE
    run_console_test('6\n10\n16\n20\n',expected_output)
################################################################################
##2020-03-26
