...
def get_order():
    ...
    size = str(input("Large or small (L or S)?:")).upper().replace('"','')
    if size == "L":
    ...
    cheese = str(input("Cheese (Y or N)?: ")).upper().replace('"','')
    if cheese == "Y":
        final_order['toppings'].append("cheese")

    tomatoes = str(input("Tomatoes (Y or N)?: ")).upper().replace('"','')
    if tomatoes == "Y":
        final_order['toppings'].append("tomatoes")

    lettuce = str(input("Lettuce (Y or N)?: ")).upper().replace('"','')
    if lettuce == "Y":
        final_order['toppings'].append("lettuce")

    onions = str(input("Onions (Y or N)?: ")).upper().replace('"','')
    if onions == "Y":
