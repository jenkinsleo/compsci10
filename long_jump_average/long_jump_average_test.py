...
TARGET_FILE = 'long_jump_average.py'
...
def run_tests():
    ...
    run_console_test('5.5\n4.5\n3.0\n5\n','Average = 5.0')

    ##test3 - 1st value is min
    run_console_test('3.0\n5.5\n4.5\n5\n','Average = 5.0')

    ##test4 - 2nd value is min
    run_console_test('5.5\n3.0\n4.5\n5\n','Average = 5.0')

    ##test5 - 3rd value is min
    run_console_test('5.5\n4.5\n3.0\n5\n','Average = 5.0')

    ##test6 - 4th value is min
    run_console_test('5.5\n4.5\n5\n3.0\n','Average = 5.0')

    ##test6 - 2 minimum values
    run_console_test('4.0\n4.5\n5\n4.0\n','Average = 4.5')
